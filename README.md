...
最新リリース: [v1.1.1](https://github.com/TMSystems-Rights/Electron-Tms-Grep-For-Release/releases/tag/v1.1.1)
...
出力先: `release/<version>/TmsGrep-<version>-setup.exe`（例: `release/1.1.1/TmsGrep-1.1.1-setup.exe`）
